...
This directory contains my October 2024 and onwards solves.

The setup utilizes the [`quick.sh`](quick.sh) script to generate my templates and run my files. This is my setup so it is not made for any third party usage.
